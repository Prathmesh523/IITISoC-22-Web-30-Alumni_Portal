...
function Opportunities() {
    ...
    const [formdata, setformdata] = useState({
        ...
        about: "",
        description: "",
        by: (userinfo.user)?userinfo.user.name:"",
    ...
    const user = (userinfo.user)?userinfo.user.status:"";
        ...
        <div className="eventpage">
            <div className="side-nav">
                ...
                <div style={{ display: (size.width <= 800) ? (navappear ? "block" : "none") : "block" }}>
                    ...
                    <nav id="sideEvents">
                        <ul>
                            <li style={{display: (userinfo.user)?"block":"none"}} onClick={() => navigate("/opportunities", {state: "me"})}><span>Posted By Me</span></li>
                        </ul>
                    </nav>
                </div>
            </div>
