    ...
    return (
        <div className="cardbox">
            ...
            <div className="card-content">
                ...
                <div id="story-heading"><a href="#">{props.heading}</a></div>
                <div style={{fontSize: "0.85em", marginBottom: "13px"}}>{props.content}</div>
                <div>
                    <button style={{backgroundColor: "#9aeced"}} type="button" class="btn btn-sm rounded-pill" disabled>{props.tag}</button>
                </div>
            </div>
        </div>
    );
