                            ...
                            <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a className="dropdown-item" href={(state.user && state.user.status==="admin")?"/adirectory":"/directory"}>Alumni - List View</a></li>
                                            <li><Link className="dropdown-item" to="/batch">Alumni - Batchwise</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href={(state.user)?"/opportunities":"/login"}>OPPORTUNITIES</a>
                                    </li>
                                    <li style={{display: (state.user && state.user.status==="admin")?"block":"none"}} className="nav-item">
